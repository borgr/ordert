...
#SBATCH --output=/cs/snapless/oabend/borgr/ordert/slurm/gen_gpt2%j.out
...
prompts=/cs/labs/daphna/guy.hacohen/borgr/ordert/prompts/valtest.en

module load tensorflow/2.0.0
source /cs/snapless/oabend/borgr/envs/ordert/bin/activate
...
if [ -d $working_dir/output/$model_name ]; then
  echo "previous training found, continue training"
