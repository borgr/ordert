...
#SBATCH --output=/cs/snapless/oabend/borgr/ordert/slurm/en_xlBig%j.out
...
eval_path=${data_dir}/replica_val_short.$lang # to debug
...
python $script_path $continue_training \
    ...
    --block_size=256 # block_size <= n_positions in the config file
#    --config_name $config \
#
#    --n_gpu 4 \
